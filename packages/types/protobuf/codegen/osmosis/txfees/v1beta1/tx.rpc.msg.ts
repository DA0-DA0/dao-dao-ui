...
export class MsgClientImpl implements Msg {
  ...
  setFeeTokens(request: MsgSetFeeTokens, useInterfaces: boolean = true): Promise<MsgSetFeeTokensResponse> {
    ...
    return promise.then(data => MsgSetFeeTokensResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
}
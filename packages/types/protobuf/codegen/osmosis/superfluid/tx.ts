...
export interface MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition {
  sender: string;
  lockId: bigint;
  sharesToMigrate: Coin | undefined;
...
export interface MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionAmino {
  sender?: string;
  lock_id?: string;
  shares_to_migrate?: CoinAmino | undefined;
  /** token_out_mins indicates minimum token to exit Balancer pool with. */
...
export interface MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionSDKType {
  sender: string;
  lock_id: bigint;
  shares_to_migrate: CoinSDKType | undefined;
...
export interface MsgAddToConcentratedLiquiditySuperfluidPositionAmino {
  position_id?: string;
  sender?: string;
  token_desired0?: CoinAmino | undefined;
  token_desired1?: CoinAmino | undefined;
}
...
export interface MsgAddToConcentratedLiquiditySuperfluidPositionSDKType {
  position_id: bigint;
  sender: string;
  token_desired0: CoinSDKType | undefined;
  token_desired1: CoinSDKType | undefined;
}
...
export interface MsgUnbondConvertAndStakeAmino {
   ...
   * For all other cases, this field would be disregarded.
   */
  shares_to_convert?: CoinAmino | undefined;
}
...
export interface MsgUnbondConvertAndStakeSDKType {
  ...
  val_addr: string;
  min_amt_to_stake: string;
  shares_to_convert: CoinSDKType | undefined;
}
...
export const MsgSuperfluidUndelegateAndUnbondLock = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgSuperfluidUndelegateAndUnbondLock {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgSuperfluidUndelegateAndUnbondLock, useInterfaces: boolean = false): MsgSuperfluidUndelegateAndUnbondLockAmino {
    const obj: any = {};
    obj.sender = message.sender === "" ? undefined : message.sender;
    obj.lock_id = message.lockId !== BigInt(0) ? message.lockId.toString() : undefined;
  ...
  fromProtoMsg(message: MsgSuperfluidUndelegateAndUnbondLockProtoMsg, useInterfaces: boolean = false): MsgSuperfluidUndelegateAndUnbondLock {
    return MsgSuperfluidUndelegateAndUnbondLock.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgSuperfluidUndelegateAndUnbondLockResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgSuperfluidUndelegateAndUnbondLockResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgSuperfluidUndelegateAndUnbondLockResponse, useInterfaces: boolean = false): MsgSuperfluidUndelegateAndUnbondLockResponseAmino {
    const obj: any = {};
    obj.lock_id = message.lockId !== BigInt(0) ? message.lockId.toString() : undefined;
    return obj;
  },
  ...
  toAminoMsg(message: MsgSuperfluidUndelegateAndUnbondLockResponse, useInterfaces: boolean = false): MsgSuperfluidUndelegateAndUnbondLockResponseAminoMsg {
    return {
      type: "osmosis/superfluid-undelegate-and-unbond-lock-response",
      value: MsgSuperfluidUndelegateAndUnbondLockResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgSuperfluidUndelegateAndUnbondLockResponseProtoMsg, useInterfaces: boolean = false): MsgSuperfluidUndelegateAndUnbondLockResponse {
    return MsgSuperfluidUndelegateAndUnbondLockResponse.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgCreateFullRangePositionAndSuperfluidDelegate = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgCreateFullRangePositionAndSuperfluidDelegate {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgCreateFullRangePositionAndSuperfluidDelegate, useInterfaces: boolean = false): MsgCreateFullRangePositionAndSuperfluidDelegateAmino {
    const obj: any = {};
    obj.sender = message.sender === "" ? undefined : message.sender;
    if (message.coins) {
      obj.coins = message.coins.map(e => e ? Coin.toAmino(e, useInterfaces) : undefined);
  ...
  toAminoMsg(message: MsgCreateFullRangePositionAndSuperfluidDelegate, useInterfaces: boolean = false): MsgCreateFullRangePositionAndSuperfluidDelegateAminoMsg {
    return {
      type: "osmosis/full-range-and-sf-delegate",
      value: MsgCreateFullRangePositionAndSuperfluidDelegate.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgCreateFullRangePositionAndSuperfluidDelegateProtoMsg, useInterfaces: boolean = false): MsgCreateFullRangePositionAndSuperfluidDelegate {
    return MsgCreateFullRangePositionAndSuperfluidDelegate.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgCreateFullRangePositionAndSuperfluidDelegateResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgCreateFullRangePositionAndSuperfluidDelegateResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgCreateFullRangePositionAndSuperfluidDelegateResponse, useInterfaces: boolean = false): MsgCreateFullRangePositionAndSuperfluidDelegateResponseAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: MsgCreateFullRangePositionAndSuperfluidDelegateResponse, useInterfaces: boolean = false): MsgCreateFullRangePositionAndSuperfluidDelegateResponseAminoMsg {
    return {
      type: "osmosis/create-full-range-position-and-superfluid-delegate-response",
      value: MsgCreateFullRangePositionAndSuperfluidDelegateResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgCreateFullRangePositionAndSuperfluidDelegateResponseProtoMsg, useInterfaces: boolean = false): MsgCreateFullRangePositionAndSuperfluidDelegateResponse {
    return MsgCreateFullRangePositionAndSuperfluidDelegateResponse.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.sharesToMigrate = Coin.decode(reader, reader.uint32(), useInterfaces);
          break;
        case 4:
  ...
  toAmino(message: MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition, useInterfaces: boolean = false): MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionAmino {
    const obj: any = {};
    obj.sender = message.sender === "" ? undefined : message.sender;
    obj.lock_id = message.lockId !== BigInt(0) ? message.lockId.toString() : undefined;
    obj.shares_to_migrate = message.sharesToMigrate ? Coin.toAmino(message.sharesToMigrate, useInterfaces) : undefined;
  ...
  toAminoMsg(message: MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition, useInterfaces: boolean = false): MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionAminoMsg {
    return {
      type: "osmosis/unlock-and-migrate",
      value: MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionProtoMsg, useInterfaces: boolean = false): MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition {
    return MsgUnlockAndMigrateSharesToFullRangeConcentratedPosition.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse, useInterfaces: boolean = false): MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponseAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse, useInterfaces: boolean = false): MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponseAminoMsg {
    return {
      type: "osmosis/unlock-and-migrate-shares-to-full-range-concentrated-position-response",
      value: MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponseProtoMsg, useInterfaces: boolean = false): MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse {
    return MsgUnlockAndMigrateSharesToFullRangeConcentratedPositionResponse.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgAddToConcentratedLiquiditySuperfluidPosition = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgAddToConcentratedLiquiditySuperfluidPosition {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.tokenDesired0 = Coin.decode(reader, reader.uint32(), useInterfaces);
          break;
        case 4:
          message.tokenDesired1 = Coin.decode(reader, reader.uint32(), useInterfaces);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  toAmino(message: MsgAddToConcentratedLiquiditySuperfluidPosition, useInterfaces: boolean = false): MsgAddToConcentratedLiquiditySuperfluidPositionAmino {
    const obj: any = {};
    obj.position_id = message.positionId !== BigInt(0) ? message.positionId.toString() : undefined;
    obj.sender = message.sender === "" ? undefined : message.sender;
    obj.token_desired0 = message.tokenDesired0 ? Coin.toAmino(message.tokenDesired0, useInterfaces) : undefined;
  ...
  toAminoMsg(message: MsgAddToConcentratedLiquiditySuperfluidPosition, useInterfaces: boolean = false): MsgAddToConcentratedLiquiditySuperfluidPositionAminoMsg {
    return {
      type: "osmosis/add-to-cl-superfluid-position",
      value: MsgAddToConcentratedLiquiditySuperfluidPosition.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgAddToConcentratedLiquiditySuperfluidPositionProtoMsg, useInterfaces: boolean = false): MsgAddToConcentratedLiquiditySuperfluidPosition {
    return MsgAddToConcentratedLiquiditySuperfluidPosition.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgAddToConcentratedLiquiditySuperfluidPositionResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgAddToConcentratedLiquiditySuperfluidPositionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgAddToConcentratedLiquiditySuperfluidPositionResponse, useInterfaces: boolean = false): MsgAddToConcentratedLiquiditySuperfluidPositionResponseAmino {
    const obj: any = {};
    obj.position_id = message.positionId !== BigInt(0) ? message.positionId.toString() : undefined;
    obj.amount0 = message.amount0 === "" ? undefined : message.amount0;
    obj.amount1 = message.amount1 === "" ? undefined : message.amount1;
  ...
  toAminoMsg(message: MsgAddToConcentratedLiquiditySuperfluidPositionResponse, useInterfaces: boolean = false): MsgAddToConcentratedLiquiditySuperfluidPositionResponseAminoMsg {
    return {
      type: "osmosis/add-to-concentrated-liquidity-superfluid-position-response",
      value: MsgAddToConcentratedLiquiditySuperfluidPositionResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgAddToConcentratedLiquiditySuperfluidPositionResponseProtoMsg, useInterfaces: boolean = false): MsgAddToConcentratedLiquiditySuperfluidPositionResponse {
    return MsgAddToConcentratedLiquiditySuperfluidPositionResponse.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgUnbondConvertAndStake = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgUnbondConvertAndStake {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.sharesToConvert = Coin.decode(reader, reader.uint32(), useInterfaces);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  toAmino(message: MsgUnbondConvertAndStake, useInterfaces: boolean = false): MsgUnbondConvertAndStakeAmino {
    const obj: any = {};
    obj.lock_id = message.lockId !== BigInt(0) ? message.lockId.toString() : undefined;
    obj.sender = message.sender === "" ? undefined : message.sender;
    obj.val_addr = message.valAddr === "" ? undefined : message.valAddr;
    obj.min_amt_to_stake = message.minAmtToStake === "" ? undefined : message.minAmtToStake;
    obj.shares_to_convert = message.sharesToConvert ? Coin.toAmino(message.sharesToConvert, useInterfaces) : undefined;
    return obj;
  },
  ...
  toAminoMsg(message: MsgUnbondConvertAndStake, useInterfaces: boolean = false): MsgUnbondConvertAndStakeAminoMsg {
    return {
      type: "osmosis/unbond-convert-and-stake",
      value: MsgUnbondConvertAndStake.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgUnbondConvertAndStakeProtoMsg, useInterfaces: boolean = false): MsgUnbondConvertAndStake {
    return MsgUnbondConvertAndStake.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgUnbondConvertAndStakeResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgUnbondConvertAndStakeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgUnbondConvertAndStakeResponse, useInterfaces: boolean = false): MsgUnbondConvertAndStakeResponseAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: MsgUnbondConvertAndStakeResponse, useInterfaces: boolean = false): MsgUnbondConvertAndStakeResponseAminoMsg {
    return {
      type: "osmosis/unbond-convert-and-stake-response",
      value: MsgUnbondConvertAndStakeResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgUnbondConvertAndStakeResponseProtoMsg, useInterfaces: boolean = false): MsgUnbondConvertAndStakeResponse {
    return MsgUnbondConvertAndStakeResponse.decode(message.value, undefined, useInterfaces);
  },

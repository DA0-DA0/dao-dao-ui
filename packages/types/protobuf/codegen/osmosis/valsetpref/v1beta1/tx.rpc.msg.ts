...
export class MsgClientImpl implements Msg {
  ...
  undelegateFromRebalancedValidatorSet(request: MsgUndelegateFromRebalancedValidatorSet, useInterfaces: boolean = true): Promise<MsgUndelegateFromRebalancedValidatorSetResponse> {
    ...
    return promise.then(data => MsgUndelegateFromRebalancedValidatorSetResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }

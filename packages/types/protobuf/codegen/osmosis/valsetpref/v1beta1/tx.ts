...
export const MsgUndelegateFromRebalancedValidatorSet = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgUndelegateFromRebalancedValidatorSet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgUndelegateFromRebalancedValidatorSet, useInterfaces: boolean = false): MsgUndelegateFromRebalancedValidatorSetAmino {
    const obj: any = {};
    obj.delegator = message.delegator === "" ? undefined : message.delegator;
    obj.coin = message.coin ? Coin.toAmino(message.coin, useInterfaces) : undefined;
    return obj;
  ...
  toAminoMsg(message: MsgUndelegateFromRebalancedValidatorSet, useInterfaces: boolean = false): MsgUndelegateFromRebalancedValidatorSetAminoMsg {
    return {
      type: "osmosis/MsgUndelegateFromRebalValset",
      value: MsgUndelegateFromRebalancedValidatorSet.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgUndelegateFromRebalancedValidatorSetProtoMsg, useInterfaces: boolean = false): MsgUndelegateFromRebalancedValidatorSet {
    return MsgUndelegateFromRebalancedValidatorSet.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgUndelegateFromRebalancedValidatorSetResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgUndelegateFromRebalancedValidatorSetResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(_: MsgUndelegateFromRebalancedValidatorSetResponse, useInterfaces: boolean = false): MsgUndelegateFromRebalancedValidatorSetResponseAmino {
    const obj: any = {};
    return obj;
  },
  ...
  toAminoMsg(message: MsgUndelegateFromRebalancedValidatorSetResponse, useInterfaces: boolean = false): MsgUndelegateFromRebalancedValidatorSetResponseAminoMsg {
    return {
      type: "osmosis/valsetpref/undelegate-from-rebalanced-validator-set-response",
      value: MsgUndelegateFromRebalancedValidatorSetResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgUndelegateFromRebalancedValidatorSetResponseProtoMsg, useInterfaces: boolean = false): MsgUndelegateFromRebalancedValidatorSetResponse {
    return MsgUndelegateFromRebalancedValidatorSetResponse.decode(message.value, undefined, useInterfaces);
  },

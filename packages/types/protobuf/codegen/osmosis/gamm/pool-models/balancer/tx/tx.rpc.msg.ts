...
export class MsgClientImpl implements Msg {
  ...
  createBalancerPool(request: MsgCreateBalancerPool, useInterfaces: boolean = true): Promise<MsgCreateBalancerPoolResponse> {
    ...
    return promise.then(data => MsgCreateBalancerPoolResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
}
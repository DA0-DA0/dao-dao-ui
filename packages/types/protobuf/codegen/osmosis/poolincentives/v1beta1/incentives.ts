...
export const AnyPoolToInternalGauges = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): AnyPoolToInternalGauges {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: AnyPoolToInternalGauges, useInterfaces: boolean = false): AnyPoolToInternalGaugesAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: AnyPoolToInternalGauges, useInterfaces: boolean = false): AnyPoolToInternalGaugesAminoMsg {
    return {
      type: "osmosis/poolincentives/any-pool-to-internal-gauges",
      value: AnyPoolToInternalGauges.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: AnyPoolToInternalGaugesProtoMsg, useInterfaces: boolean = false): AnyPoolToInternalGauges {
    return AnyPoolToInternalGauges.decode(message.value, undefined, useInterfaces);
  },
...
export const ConcentratedPoolToNoLockGauges = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): ConcentratedPoolToNoLockGauges {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: ConcentratedPoolToNoLockGauges, useInterfaces: boolean = false): ConcentratedPoolToNoLockGaugesAmino {
    const obj: any = {};
    if (message.poolToGauge) {
      obj.pool_to_gauge = message.poolToGauge.map(e => e ? PoolToGauge.toAmino(e, useInterfaces) : undefined);
    } else {
  ...
  toAminoMsg(message: ConcentratedPoolToNoLockGauges, useInterfaces: boolean = false): ConcentratedPoolToNoLockGaugesAminoMsg {
    return {
      type: "osmosis/poolincentives/concentrated-pool-to-no-lock-gauges",
      value: ConcentratedPoolToNoLockGauges.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: ConcentratedPoolToNoLockGaugesProtoMsg, useInterfaces: boolean = false): ConcentratedPoolToNoLockGauges {
    return ConcentratedPoolToNoLockGauges.decode(message.value, undefined, useInterfaces);
  },

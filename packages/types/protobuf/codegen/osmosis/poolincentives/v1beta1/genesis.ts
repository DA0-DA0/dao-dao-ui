...
export interface GenesisStateAmino {
   ...
   * link
   */
  any_pool_to_internal_gauges?: AnyPoolToInternalGaugesAmino | undefined;
  /**
   * concentrated_pool_to_no_lock_gauges defines the no lock gauges for
   * concentrated pool. This only exists between concentrated pool and no lock
   * gauges. Both external and internal gauges are included.
   */
  concentrated_pool_to_no_lock_gauges?: ConcentratedPoolToNoLockGaugesAmino | undefined;
}
...
export interface GenesisStateSDKType {
  ...
  any_pool_to_internal_gauges?: AnyPoolToInternalGaugesSDKType | undefined;
  concentrated_pool_to_no_lock_gauges?: ConcentratedPoolToNoLockGaugesSDKType | undefined;
}
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.anyPoolToInternalGauges = AnyPoolToInternalGauges.decode(reader, reader.uint32(), useInterfaces);
          break;
        case 5:
          message.concentratedPoolToNoLockGauges = ConcentratedPoolToNoLockGauges.decode(reader, reader.uint32(), useInterfaces);
          break;
        default:
  ...
  toAmino(message: GenesisState, useInterfaces: boolean = false): GenesisStateAmino {
    ...
    obj.any_pool_to_internal_gauges = message.anyPoolToInternalGauges ? AnyPoolToInternalGauges.toAmino(message.anyPoolToInternalGauges, useInterfaces) : undefined;
    obj.concentrated_pool_to_no_lock_gauges = message.concentratedPoolToNoLockGauges ? ConcentratedPoolToNoLockGauges.toAmino(message.concentratedPoolToNoLockGauges, useInterfaces) : undefined;
    return obj;
  },

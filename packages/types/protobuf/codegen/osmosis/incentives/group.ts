...
export interface GroupAmino {
  ...
  internal_gauge_info?: InternalGaugeInfoAmino | undefined;
...
export interface GroupSDKType {
  ...
  internal_gauge_info: InternalGaugeInfoSDKType | undefined;
  splitting_policy: SplittingPolicy;
}
/**
...
export const InternalGaugeInfo = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): InternalGaugeInfo {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.gaugeRecords.push(InternalGaugeRecord.decode(reader, reader.uint32(), useInterfaces));
          break;
        default:
  ...
  toAminoMsg(message: InternalGaugeInfo, useInterfaces: boolean = false): InternalGaugeInfoAminoMsg {
    return {
      type: "osmosis/incentives/internal-gauge-info",
      value: InternalGaugeInfo.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: InternalGaugeInfoProtoMsg, useInterfaces: boolean = false): InternalGaugeInfo {
    return InternalGaugeInfo.decode(message.value, undefined, useInterfaces);
  },
...
export const InternalGaugeRecord = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): InternalGaugeRecord {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAminoMsg(message: InternalGaugeRecord, useInterfaces: boolean = false): InternalGaugeRecordAminoMsg {
    return {
      type: "osmosis/incentives/internal-gauge-record",
      value: InternalGaugeRecord.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: InternalGaugeRecordProtoMsg, useInterfaces: boolean = false): InternalGaugeRecord {
    return InternalGaugeRecord.decode(message.value, undefined, useInterfaces);
  },
...
export const Group = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.internalGaugeInfo = InternalGaugeInfo.decode(reader, reader.uint32(), useInterfaces);
          break;
        case 3:
  ...
  toAminoMsg(message: Group, useInterfaces: boolean = false): GroupAminoMsg {
    return {
      type: "osmosis/incentives/group",
      value: Group.toAmino(message, useInterfaces)
    };
  },
...
export const CreateGroup = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): CreateGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: CreateGroup, useInterfaces: boolean = false): CreateGroupAmino {
    const obj: any = {};
    if (message.poolIds) {
  ...
  toAminoMsg(message: CreateGroup, useInterfaces: boolean = false): CreateGroupAminoMsg {
    return {
      type: "osmosis/incentives/create-group",
      value: CreateGroup.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: CreateGroupProtoMsg, useInterfaces: boolean = false): CreateGroup {
    return CreateGroup.decode(message.value, undefined, useInterfaces);
  },
...
export const GroupsWithGauge = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): GroupsWithGauge {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: GroupsWithGauge, useInterfaces: boolean = false): GroupsWithGaugeAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: GroupsWithGauge, useInterfaces: boolean = false): GroupsWithGaugeAminoMsg {
    return {
      type: "osmosis/incentives/groups-with-gauge",
      value: GroupsWithGauge.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: GroupsWithGaugeProtoMsg, useInterfaces: boolean = false): GroupsWithGauge {
    return GroupsWithGauge.decode(message.value, undefined, useInterfaces);
  },

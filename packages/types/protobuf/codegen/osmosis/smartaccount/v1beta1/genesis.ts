...
export const AuthenticatorData = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): AuthenticatorData {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.authenticators.push(AccountAuthenticator.decode(reader, reader.uint32(), useInterfaces));
          break;
        default:
  ...
  toAminoMsg(message: AuthenticatorData, useInterfaces: boolean = false): AuthenticatorDataAminoMsg {
    return {
      type: "osmosis/smartaccount/authenticator-data",
      value: AuthenticatorData.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: AuthenticatorDataProtoMsg, useInterfaces: boolean = false): AuthenticatorData {
    return AuthenticatorData.decode(message.value, undefined, useInterfaces);
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.authenticatorData.push(AuthenticatorData.decode(reader, reader.uint32(), useInterfaces));
          break;
        default:
          reader.skipType(tag & 7);
          break;

...
export const AccountAuthenticator = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): AccountAuthenticator {
  ...
  toAminoMsg(message: AccountAuthenticator, useInterfaces: boolean = false): AccountAuthenticatorAminoMsg {
    return {
      type: "osmosis/smartaccount/account-authenticator",
      value: AccountAuthenticator.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: AccountAuthenticatorProtoMsg, useInterfaces: boolean = false): AccountAuthenticator {
    return AccountAuthenticator.decode(message.value, undefined, useInterfaces);
  },

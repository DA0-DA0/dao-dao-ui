...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    pstake: {
      ...
      liquidstakeibc: {
        v1beta1: (await import("./liquidstakeibc/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      lscosmos: {
        v1beta1: (await import("./lscosmos/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      ratesync: {
        v1beta1: (await import("./ratesync/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      }
    }
  };
};
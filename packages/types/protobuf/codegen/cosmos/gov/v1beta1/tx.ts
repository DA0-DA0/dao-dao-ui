...
import { ConsumerAdditionProposal, ConsumerAdditionProposalProtoMsg, ConsumerAdditionProposalSDKType, ConsumerRemovalProposal, ConsumerRemovalProposalProtoMsg, ConsumerRemovalProposalSDKType, ChangeRewardDenomsProposal, ChangeRewardDenomsProposalProtoMsg, ChangeRewardDenomsProposalSDKType } from "../../../interchain_security/ccv/provider/v1/provider";
...
export const Cosmos_govv1beta1Content_InterfaceDecoder = (input: BinaryReader | Uint8Array): MsgCreateAllianceProposal | MsgUpdateAllianceProposal | MsgDeleteAllianceProposal | CommunityPoolSpendProposal | CommunityPoolSpendProposalWithDeposit | TextProposal | ParameterChangeProposal | SoftwareUpgradeProposal | CancelSoftwareUpgradeProposal | StoreCodeProposal | InstantiateContractProposal | InstantiateContract2Proposal | MigrateContractProposal | SudoContractProposal | ExecuteContractProposal | UpdateAdminProposal | ClearAdminProposal | PinCodesProposal | UnpinCodesProposal | UpdateInstantiateConfigProposal | StoreAndInstantiateContractProposal | ConsumerAdditionProposal | ConsumerRemovalProposal | ChangeRewardDenomsProposal | ReplaceMigrationRecordsProposal | UpdateMigrationRecordsProposal | CreateConcentratedLiquidityPoolsAndLinktoCFMMProposal | SetScalingFactorControllerProposal | CreateGroupsProposal | ReplacePoolIncentivesProposal | UpdatePoolIncentivesProposal | SetProtoRevEnabledProposal | SetProtoRevAdminAccountProposal | SetSuperfluidAssetsProposal | RemoveSuperfluidAssetsProposal | UpdateUnpoolWhiteListProposal | UpdateFeeTokenProposal | PromoteToPrivilegedContractProposal | DemotePrivilegedContractProposal | SetCodeAuthorizationProposal | RemoveCodeAuthorizationProposal | SetContractAuthorizationProposal | RemoveContractAuthorizationProposal | AllowDenomProposal | CreditTypeProposal | Any => {
  ...
  switch (data.typeUrl) {
    ...
    case "/interchain_security.ccv.provider.v1.ConsumerAdditionProposal":
      return ConsumerAdditionProposal.decode(data.value, undefined, true);
    case "/interchain_security.ccv.provider.v1.ConsumerRemovalProposal":
      return ConsumerRemovalProposal.decode(data.value, undefined, true);
    case "/interchain_security.ccv.provider.v1.ChangeRewardDenomsProposal":
      return ChangeRewardDenomsProposal.decode(data.value, undefined, true);
  ...
  switch (content.type) {
    ...
    case "/interchain_security.ccv.provider.v1.ConsumerAdditionProposal":
      return Any.fromPartial({
        ...
        value: ConsumerAdditionProposal.encode(ConsumerAdditionProposal.fromPartial(ConsumerAdditionProposal.fromAmino(content.value))).finish()
      });
    case "/interchain_security.ccv.provider.v1.ConsumerRemovalProposal":
      return Any.fromPartial({
        typeUrl: "/interchain_security.ccv.provider.v1.ConsumerRemovalProposal",
        value: ConsumerRemovalProposal.encode(ConsumerRemovalProposal.fromPartial(ConsumerRemovalProposal.fromAmino(content.value))).finish()
      });
    case "/interchain_security.ccv.provider.v1.ChangeRewardDenomsProposal":
      return Any.fromPartial({
        typeUrl: "/interchain_security.ccv.provider.v1.ChangeRewardDenomsProposal",
        value: ChangeRewardDenomsProposal.encode(ChangeRewardDenomsProposal.fromPartial(ChangeRewardDenomsProposal.fromAmino(content.value))).finish()
      });
  ...
  switch (content.typeUrl) {
    ...
    case "/interchain_security.ccv.provider.v1.ConsumerAdditionProposal":
      return {
        ...
        value: ConsumerAdditionProposal.toAmino(ConsumerAdditionProposal.decode(content.value, undefined, useInterfaces), useInterfaces)
      };
    case "/interchain_security.ccv.provider.v1.ConsumerRemovalProposal":
      return {
        type: "/interchain_security.ccv.provider.v1.ConsumerRemovalProposal",
        value: ConsumerRemovalProposal.toAmino(ConsumerRemovalProposal.decode(content.value, undefined, useInterfaces), useInterfaces)
      };
    case "/interchain_security.ccv.provider.v1.ChangeRewardDenomsProposal":
      return {
        type: "/interchain_security.ccv.provider.v1.ChangeRewardDenomsProposal",
        value: ChangeRewardDenomsProposal.toAmino(ChangeRewardDenomsProposal.decode(content.value, undefined, useInterfaces), useInterfaces)
      };
    case "/osmosis.gamm.v1beta1.ReplaceMigrationRecordsProposal":
      return {

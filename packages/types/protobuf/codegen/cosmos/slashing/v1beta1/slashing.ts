...
export const Params = {
  ...
  toAmino(message: Params, useInterfaces: boolean = false): ParamsAmino {
    ...
    obj.downtime_jail_duration = message.downtimeJailDuration ? Duration.toAmino(message.downtimeJailDuration, useInterfaces) : Duration.toAmino(Duration.fromPartial({}));

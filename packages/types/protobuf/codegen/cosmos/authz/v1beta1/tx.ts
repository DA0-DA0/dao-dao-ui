...
export const MsgGrant = {
  ...
  toAmino(message: MsgGrant, useInterfaces: boolean = false): MsgGrantAmino {
    ...
    obj.grant = message.grant
      ? Grant.toAmino(message.grant, useInterfaces)
      : Grant.fromPartial({})
    return obj
  },
...
export const MsgGrantResponse = {
  ...
  fromProtoMsg(
    message: MsgGrantResponseProtoMsg,
    useInterfaces: boolean = false
  ): MsgGrantResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.msgs.push(
            useInterfaces
              ? (Cosmos_basev1beta1Msg_InterfaceDecoder(reader) as Any)
  ...
  toAmino(message: MsgExec, useInterfaces: boolean = false): MsgExecAmino {
    ...
    if (message.msgs) {
      obj.msgs = message.msgs.map((e) =>
        e ? rawProtobufMsgToAmino(e as Any, useInterfaces) : undefined
      )
    } else {
      obj.msgs = []
    }
...
export const MsgExecResponse = {
  ...
  fromProtoMsg(
    message: MsgExecResponseProtoMsg,
    useInterfaces: boolean = false
  ): MsgExecResponse {
...
export const MsgRevokeResponse = {
  ...
  fromProtoMsg(
    message: MsgRevokeResponseProtoMsg,
    useInterfaces: boolean = false
  ): MsgRevokeResponse {

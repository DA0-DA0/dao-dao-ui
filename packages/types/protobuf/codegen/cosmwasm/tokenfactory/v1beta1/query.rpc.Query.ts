...
export class QueryClientImpl implements Query {
  ...
  params(request: QueryParamsRequest = {}, useInterfaces: boolean = true): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("cosmwasm.tokenfactory.v1beta1.Query", "Params", data);
  ...
  denomAuthorityMetadata(request: QueryDenomAuthorityMetadataRequest, useInterfaces: boolean = true): Promise<QueryDenomAuthorityMetadataResponse> {
    ...
    const promise = this.rpc.request("cosmwasm.tokenfactory.v1beta1.Query", "DenomAuthorityMetadata", data);
  ...
  denomsFromCreator(request: QueryDenomsFromCreatorRequest, useInterfaces: boolean = true): Promise<QueryDenomsFromCreatorResponse> {
    ...
    const promise = this.rpc.request("cosmwasm.tokenfactory.v1beta1.Query", "DenomsFromCreator", data);

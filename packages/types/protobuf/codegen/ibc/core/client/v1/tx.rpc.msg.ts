...
export class MsgClientImpl implements Msg {
  ...
  recoverClient(request: MsgRecoverClient, useInterfaces: boolean = true): Promise<MsgRecoverClientResponse> {
    ...
    return promise.then(data => MsgRecoverClientResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  iBCSoftwareUpgrade(request: MsgIBCSoftwareUpgrade, useInterfaces: boolean = true): Promise<MsgIBCSoftwareUpgradeResponse> {
    ...
    return promise.then(data => MsgIBCSoftwareUpgradeResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }

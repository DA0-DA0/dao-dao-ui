...
export class QueryClientImpl implements Query {
  ...
  verifyMembership(request: QueryVerifyMembershipRequest, useInterfaces: boolean = true): Promise<QueryVerifyMembershipResponse> {
    ...
    return promise.then(data => QueryVerifyMembershipResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
}
export const createRpcQueryExtension = (base: QueryClient) => {
  ...
  return {
    ...
    verifyMembership(request: QueryVerifyMembershipRequest, useInterfaces: boolean = true): Promise<QueryVerifyMembershipResponse> {
      return queryService.verifyMembership(request, useInterfaces);
    }
  };
};
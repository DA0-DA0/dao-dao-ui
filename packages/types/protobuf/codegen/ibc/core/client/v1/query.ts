...
export interface QueryVerifyMembershipRequestSDKType {
  ...
  time_delay: bigint;
  block_delay: bigint;
  merkle_path: MerklePathSDKType | undefined;
}
...
export const QueryVerifyMembershipRequest = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): QueryVerifyMembershipRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          break;
        case 8:
          message.merklePath = MerklePath.decode(reader, reader.uint32(), useInterfaces);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  toAmino(message: QueryVerifyMembershipRequest, useInterfaces: boolean = false): QueryVerifyMembershipRequestAmino {
    const obj: any = {};
    obj.client_id = message.clientId === "" ? undefined : message.clientId;
    obj.proof = message.proof ? base64FromBytes(message.proof) : undefined;
    obj.proof_height = message.proofHeight ? Height.toAmino(message.proofHeight, useInterfaces) : {};
    ...
    obj.merkle_path = message.merklePath ? MerklePath.toAmino(message.merklePath, useInterfaces) : undefined;
    return obj;
  },
  ...
  toAminoMsg(message: QueryVerifyMembershipRequest, useInterfaces: boolean = false): QueryVerifyMembershipRequestAminoMsg {
    return {
      type: "cosmos-sdk/QueryVerifyMembershipRequest",
      value: QueryVerifyMembershipRequest.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: QueryVerifyMembershipRequestProtoMsg, useInterfaces: boolean = false): QueryVerifyMembershipRequest {
    return QueryVerifyMembershipRequest.decode(message.value, undefined, useInterfaces);
  },
...
export const QueryVerifyMembershipResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): QueryVerifyMembershipResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: QueryVerifyMembershipResponse, useInterfaces: boolean = false): QueryVerifyMembershipResponseAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: QueryVerifyMembershipResponse, useInterfaces: boolean = false): QueryVerifyMembershipResponseAminoMsg {
    return {
      type: "cosmos-sdk/QueryVerifyMembershipResponse",
      value: QueryVerifyMembershipResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: QueryVerifyMembershipResponseProtoMsg, useInterfaces: boolean = false): QueryVerifyMembershipResponse {
    return QueryVerifyMembershipResponse.decode(message.value, undefined, useInterfaces);
  },

...
export const QueryConnectionParamsRequest = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): QueryConnectionParamsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(_: QueryConnectionParamsRequest, useInterfaces: boolean = false): QueryConnectionParamsRequestAmino {
    const obj: any = {};
    return obj;
  },
  ...
  toAminoMsg(message: QueryConnectionParamsRequest, useInterfaces: boolean = false): QueryConnectionParamsRequestAminoMsg {
    return {
      type: "cosmos-sdk/QueryConnectionParamsRequest",
      value: QueryConnectionParamsRequest.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: QueryConnectionParamsRequestProtoMsg, useInterfaces: boolean = false): QueryConnectionParamsRequest {
...
export const QueryConnectionParamsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): QueryConnectionParamsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: QueryConnectionParamsResponse, useInterfaces: boolean = false): QueryConnectionParamsResponseAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: QueryConnectionParamsResponse, useInterfaces: boolean = false): QueryConnectionParamsResponseAminoMsg {
    return {
      type: "cosmos-sdk/QueryConnectionParamsResponse",
      value: QueryConnectionParamsResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: QueryConnectionParamsResponseProtoMsg, useInterfaces: boolean = false): QueryConnectionParamsResponse {

...
export const InterchainAccountPacketData = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): InterchainAccountPacketData {
  ...
  toAminoMsg(message: InterchainAccountPacketData, useInterfaces: boolean = false): InterchainAccountPacketDataAminoMsg {
    return {
      type: "cosmos-sdk/InterchainAccountPacketData",
      value: InterchainAccountPacketData.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: InterchainAccountPacketDataProtoMsg, useInterfaces: boolean = false): InterchainAccountPacketData {
...
export const CosmosTx = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): CosmosTx {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: CosmosTx, useInterfaces: boolean = false): CosmosTxAmino {
    const obj: any = {};
    if (message.messages) {
  ...
  toAminoMsg(message: CosmosTx, useInterfaces: boolean = false): CosmosTxAminoMsg {
    return {
      type: "cosmos-sdk/CosmosTx",
      value: CosmosTx.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: CosmosTxProtoMsg, useInterfaces: boolean = false): CosmosTx {

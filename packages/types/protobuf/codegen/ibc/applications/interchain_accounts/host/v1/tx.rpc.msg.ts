...
export class MsgClientImpl implements Msg {
  ...
  moduleQuerySafe(request: MsgModuleQuerySafe, useInterfaces: boolean = true): Promise<MsgModuleQuerySafeResponse> {
    ...
    return promise.then(data => MsgModuleQuerySafeResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
}
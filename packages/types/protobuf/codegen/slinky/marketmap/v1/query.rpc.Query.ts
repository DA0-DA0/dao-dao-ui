...
import { MarketMapRequest, MarketMapResponse, MarketsRequest, MarketsResponse, MarketRequest, MarketResponse, LastUpdatedRequest, LastUpdatedResponse, ParamsRequest, ParamsResponse } from "./query";
...
export class QueryClientImpl implements Query {
  ...
  marketMap(request: MarketMapRequest = {}, useInterfaces: boolean = true): Promise<MarketMapResponse> {
    const data = MarketMapRequest.encode(request).finish();
    const promise = this.rpc.request("slinky.marketmap.v1.Query", "MarketMap", data);
    return promise.then(data => MarketMapResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  markets(request: MarketsRequest = {}, useInterfaces: boolean = true): Promise<MarketsResponse> {
    const data = MarketsRequest.encode(request).finish();
    const promise = this.rpc.request("slinky.marketmap.v1.Query", "Markets", data);
    return promise.then(data => MarketsResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  market(request: MarketRequest, useInterfaces: boolean = true): Promise<MarketResponse> {
    const data = MarketRequest.encode(request).finish();
    const promise = this.rpc.request("slinky.marketmap.v1.Query", "Market", data);
    return promise.then(data => MarketResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  lastUpdated(request: LastUpdatedRequest = {}, useInterfaces: boolean = true): Promise<LastUpdatedResponse> {
    ...
    return promise.then(data => LastUpdatedResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
...
export const createRpcQueryExtension = (base: QueryClient) => {
  ...
  return {
    marketMap(request?: MarketMapRequest, useInterfaces: boolean = true): Promise<MarketMapResponse> {
      return queryService.marketMap(request, useInterfaces);
    },
    markets(request?: MarketsRequest, useInterfaces: boolean = true): Promise<MarketsResponse> {
      return queryService.markets(request, useInterfaces);
    },
    market(request: MarketRequest, useInterfaces: boolean = true): Promise<MarketResponse> {
      return queryService.market(request, useInterfaces);
    },
    lastUpdated(request?: LastUpdatedRequest, useInterfaces: boolean = true): Promise<LastUpdatedResponse> {
      return queryService.lastUpdated(request, useInterfaces);
    },
    params(request?: ParamsRequest, useInterfaces: boolean = true): Promise<ParamsResponse> {

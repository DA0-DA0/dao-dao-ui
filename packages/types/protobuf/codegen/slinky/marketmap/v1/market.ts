...
export interface MarketSDKType {
  ticker: TickerSDKType | undefined;
...
export interface ProviderConfigAmino {
   ...
   * optional and nullable.
   */
  normalize_by_pair?: CurrencyPairAmino | undefined;
  /**
   * Invert is a boolean indicating if the BASE and QUOTE of the market should
   * be inverted. i.e. BASE -> QUOTE, QUOTE -> BASE
   */
...
export interface ProviderConfigSDKType {
  name: string;
  off_chain_ticker: string;
  normalize_by_pair?: CurrencyPairSDKType | undefined;
  invert: boolean;
  metadata_JSON: string;
}
...
export interface MarketMapAmino {
   ...
   */
  markets?: {
    [key: string]: MarketAmino | undefined;
  };
}
...
export interface MarketMapSDKType {
  markets: {
    [key: string]: MarketSDKType | undefined;
  };
}
...
export const Market = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): Market {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.ticker = Ticker.decode(reader, reader.uint32(), useInterfaces);
          break;
        case 2:
          message.providerConfigs.push(ProviderConfig.decode(reader, reader.uint32(), useInterfaces));
          break;
        default:
  ...
  toAmino(message: Market, useInterfaces: boolean = false): MarketAmino {
    const obj: any = {};
    obj.ticker = message.ticker ? Ticker.toAmino(message.ticker, useInterfaces) : undefined;
    if (message.providerConfigs) {
      obj.provider_configs = message.providerConfigs.map(e => e ? ProviderConfig.toAmino(e, useInterfaces) : undefined);
    } else {
...
export const Ticker = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): Ticker {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: Ticker, useInterfaces: boolean = false): TickerAmino {
    const obj: any = {};
  ...
  fromProtoMsg(message: TickerProtoMsg, useInterfaces: boolean = false): Ticker {
...
export const ProviderConfig = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): ProviderConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.normalizeByPair = CurrencyPair.decode(reader, reader.uint32(), useInterfaces);
          break;
        case 4:
  ...
  toAmino(message: ProviderConfig, useInterfaces: boolean = false): ProviderConfigAmino {
    const obj: any = {};
    obj.name = message.name === "" ? undefined : message.name;
    obj.off_chain_ticker = message.offChainTicker === "" ? undefined : message.offChainTicker;
    obj.normalize_by_pair = message.normalizeByPair ? CurrencyPair.toAmino(message.normalizeByPair, useInterfaces) : undefined;
  ...
  fromProtoMsg(message: ProviderConfigProtoMsg, useInterfaces: boolean = false): ProviderConfig {
    return ProviderConfig.decode(message.value, undefined, useInterfaces);
  },
...
export const MarketMap_MarketsEntry = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MarketMap_MarketsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.value = Market.decode(reader, reader.uint32(), useInterfaces);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  toAmino(message: MarketMap_MarketsEntry, useInterfaces: boolean = false): MarketMap_MarketsEntryAmino {
    const obj: any = {};
    obj.key = message.key === "" ? undefined : message.key;
    obj.value = message.value ? Market.toAmino(message.value, useInterfaces) : undefined;
    return obj;
  },
  ...
  fromProtoMsg(message: MarketMap_MarketsEntryProtoMsg, useInterfaces: boolean = false): MarketMap_MarketsEntry {
    return MarketMap_MarketsEntry.decode(message.value, undefined, useInterfaces);
  },
...
export const MarketMap = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MarketMap {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MarketMap, useInterfaces: boolean = false): MarketMapAmino {
    const obj: any = {};
    obj.markets = {};
    if (message.markets) {
      Object.entries(message.markets).forEach(([k, v]) => {
        if (v !== undefined) {
          obj.markets[k] = Market.toAmino(v, useInterfaces);
        }
      });
    }
    return obj;
  ...
  fromProtoMsg(message: MarketMapProtoMsg, useInterfaces: boolean = false): MarketMap {
    return MarketMap.decode(message.value, undefined, useInterfaces);
  },

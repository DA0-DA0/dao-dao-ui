...
export const MessageComposer = {
  encoded: {
    ...
    removeMarkets(value: MsgRemoveMarkets) {
      return {
        typeUrl: "/slinky.marketmap.v1.MsgRemoveMarkets",
        value: MsgRemoveMarkets.encode(value).finish()
      };
    }
  },
  withTypeUrl: {
  ...
  fromPartial: {
    ...
    removeMarkets(value: MsgRemoveMarkets) {
      return {
        typeUrl: "/slinky.marketmap.v1.MsgRemoveMarkets",
        value: MsgRemoveMarkets.fromPartial(value)
      };
    }
  }
};
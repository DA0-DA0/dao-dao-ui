...
export const MsgAddCurrencyPairs = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgAddCurrencyPairs {
  ...
  toAmino(message: MsgAddCurrencyPairs, useInterfaces: boolean = false): MsgAddCurrencyPairsAmino {
    const obj: any = {};
  ...
  toAminoMsg(message: MsgAddCurrencyPairs, useInterfaces: boolean = false): MsgAddCurrencyPairsAminoMsg {
    return {
      type: "slinky/x/oracle/MsgAddCurrencyPairs",
      value: MsgAddCurrencyPairs.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgAddCurrencyPairsProtoMsg, useInterfaces: boolean = false): MsgAddCurrencyPairs {
    return MsgAddCurrencyPairs.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgAddCurrencyPairsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgAddCurrencyPairsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(_: MsgAddCurrencyPairsResponse, useInterfaces: boolean = false): MsgAddCurrencyPairsResponseAmino {
    const obj: any = {};
    return obj;
  },
  ...
  fromProtoMsg(message: MsgAddCurrencyPairsResponseProtoMsg, useInterfaces: boolean = false): MsgAddCurrencyPairsResponse {
    return MsgAddCurrencyPairsResponse.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgRemoveCurrencyPairs = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgRemoveCurrencyPairs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgRemoveCurrencyPairs, useInterfaces: boolean = false): MsgRemoveCurrencyPairsAmino {
    const obj: any = {};
    obj.authority = message.authority === "" ? undefined : message.authority;
  ...
  toAminoMsg(message: MsgRemoveCurrencyPairs, useInterfaces: boolean = false): MsgRemoveCurrencyPairsAminoMsg {
    return {
      type: "slinky/x/oracle/MsgSetCurrencyPairs",
      value: MsgRemoveCurrencyPairs.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgRemoveCurrencyPairsProtoMsg, useInterfaces: boolean = false): MsgRemoveCurrencyPairs {
    return MsgRemoveCurrencyPairs.decode(message.value, undefined, useInterfaces);
  },
...
export const MsgRemoveCurrencyPairsResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgRemoveCurrencyPairsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(_: MsgRemoveCurrencyPairsResponse, useInterfaces: boolean = false): MsgRemoveCurrencyPairsResponseAmino {
    const obj: any = {};
    return obj;
  },
  ...
  fromProtoMsg(message: MsgRemoveCurrencyPairsResponseProtoMsg, useInterfaces: boolean = false): MsgRemoveCurrencyPairsResponse {
    return MsgRemoveCurrencyPairsResponse.decode(message.value, undefined, useInterfaces);
  },

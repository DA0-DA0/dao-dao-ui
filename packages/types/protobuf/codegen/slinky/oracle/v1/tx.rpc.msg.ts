...
export class MsgClientImpl implements Msg {
  ...
  addCurrencyPairs(request: MsgAddCurrencyPairs, useInterfaces: boolean = true): Promise<MsgAddCurrencyPairsResponse> {
    ...
    return promise.then(data => MsgAddCurrencyPairsResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  removeCurrencyPairs(request: MsgRemoveCurrencyPairs, useInterfaces: boolean = true): Promise<MsgRemoveCurrencyPairsResponse> {
    ...
    return promise.then(data => MsgRemoveCurrencyPairsResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
}
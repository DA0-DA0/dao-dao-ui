...
export const CurrencyPair = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): CurrencyPair {
  ...
  toAmino(message: CurrencyPair, useInterfaces: boolean = false): CurrencyPairAmino {
    const obj: any = {};
  ...
  fromProtoMsg(message: CurrencyPairProtoMsg, useInterfaces: boolean = false): CurrencyPair {
    return CurrencyPair.decode(message.value, undefined, useInterfaces);
  },

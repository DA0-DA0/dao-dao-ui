...
export interface DaoVotingOnftStakedReadOnlyInterface {
...
export class DaoVotingOnftStakedQueryClient
...
export interface DaoVotingOnftStakedInterface
  extends DaoVotingOnftStakedReadOnlyInterface {
  contractAddress: string
  sender: string
  prepareStake: (
    {
...
export class DaoVotingOnftStakedClient
  extends DaoVotingOnftStakedQueryClient
  implements DaoVotingOnftStakedInterface
{
  ...
  constructor(
    ...
    this.sender = sender
    this.contractAddress = contractAddress
    this.prepareStake = this.prepareStake.bind(this)

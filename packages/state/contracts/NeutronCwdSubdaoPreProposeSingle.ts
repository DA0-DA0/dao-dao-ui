...
import { Addr, Binary } from '@dao-dao/types'
import {
  Coin,
  Config,
  DepositInfoResponse,
...
export interface NeutronCwdSubdaoPreProposeSingleReadOnlyInterface {
...
export class NeutronCwdSubdaoPreProposeSingleQueryClient
  implements NeutronCwdSubdaoPreProposeSingleReadOnlyInterface
{
...
export interface NeutronCwdSubdaoPreProposeSingleInterface
  extends NeutronCwdSubdaoPreProposeSingleReadOnlyInterface {
  contractAddress: string
  sender: string
  propose: (
    {
...
export class NeutronCwdSubdaoPreProposeSingleClient
  extends NeutronCwdSubdaoPreProposeSingleQueryClient
  implements NeutronCwdSubdaoPreProposeSingleInterface
{

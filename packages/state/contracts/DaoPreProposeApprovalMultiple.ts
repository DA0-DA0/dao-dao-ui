...
export interface DaoPreProposeApprovalMultipleReadOnlyInterface {
...
export class DaoPreProposeApprovalMultipleQueryClient
  implements DaoPreProposeApprovalMultipleReadOnlyInterface
{
...
export interface DaoPreProposeApprovalMultipleInterface
  extends DaoPreProposeApprovalMultipleReadOnlyInterface {
  contractAddress: string
  sender: string
  propose: (
    {
...
export class DaoPreProposeApprovalMultipleClient
  extends DaoPreProposeApprovalMultipleQueryClient
  implements DaoPreProposeApprovalMultipleInterface
{

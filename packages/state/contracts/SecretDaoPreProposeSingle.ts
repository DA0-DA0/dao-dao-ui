...
export class SecretDaoPreProposeSingleQueryClient
  implements SecretDaoPreProposeSingleReadOnlyInterface
{
...
export interface SecretDaoPreProposeSingleInterface
  extends SecretDaoPreProposeSingleReadOnlyInterface {
  contractAddress: string
  sender: string
  propose: (
    {
...
export class SecretDaoPreProposeSingleClient
  extends SecretDaoPreProposeSingleQueryClient
  implements SecretDaoPreProposeSingleInterface
{

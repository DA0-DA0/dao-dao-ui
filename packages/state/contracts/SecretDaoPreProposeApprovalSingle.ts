...
export class SecretDaoPreProposeApprovalSingleQueryClient
  implements SecretDaoPreProposeApprovalSingleReadOnlyInterface
{
...
export interface SecretDaoPreProposeApprovalSingleInterface
  extends SecretDaoPreProposeApprovalSingleReadOnlyInterface {
  contractAddress: string
  sender: string
  propose: (
    {
...
export class SecretDaoPreProposeApprovalSingleClient
  extends SecretDaoPreProposeApprovalSingleQueryClient
  implements SecretDaoPreProposeApprovalSingleInterface
{

...
export interface CwCoreV0_2_0ReadOnlyInterface {
...
export class CwCoreV0_2_0QueryClient implements CwCoreV0_2_0ReadOnlyInterface {
...
export interface CwCoreV0_2_0Interface extends CwCoreV0_2_0ReadOnlyInterface {
  contractAddress: string
  sender: string
  executeAdminMsgs: (
    {
...
export class CwCoreV0_2_0Client
  extends CwCoreV0_2_0QueryClient
  implements CwCoreV0_2_0Interface
{

...
export class MsgClientImpl implements Msg {
  ...
  instantiateContract2(request: MsgInstantiateContract2, useInterfaces: boolean = true): Promise<MsgInstantiateContract2Response> {
    ...
    return promise.then(data => MsgInstantiateContract2Response.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  ...
  updateInstantiateConfig(request: MsgUpdateInstantiateConfig, useInterfaces: boolean = true): Promise<MsgUpdateInstantiateConfigResponse> {
    ...
    return promise.then(data => MsgUpdateInstantiateConfigResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  ...
  sudoContract(request: MsgSudoContract, useInterfaces: boolean = true): Promise<MsgSudoContractResponse> {
    const data = MsgSudoContract.encode(request).finish();
    const promise = this.rpc.request("cosmwasm.wasm.v1.Msg", "SudoContract", data);
    return promise.then(data => MsgSudoContractResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  pinCodes(request: MsgPinCodes, useInterfaces: boolean = true): Promise<MsgPinCodesResponse> {
    const data = MsgPinCodes.encode(request).finish();
    const promise = this.rpc.request("cosmwasm.wasm.v1.Msg", "PinCodes", data);
    return promise.then(data => MsgPinCodesResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  unpinCodes(request: MsgUnpinCodes, useInterfaces: boolean = true): Promise<MsgUnpinCodesResponse> {
    const data = MsgUnpinCodes.encode(request).finish();
    const promise = this.rpc.request("cosmwasm.wasm.v1.Msg", "UnpinCodes", data);
    return promise.then(data => MsgUnpinCodesResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  storeAndInstantiateContract(request: MsgStoreAndInstantiateContract, useInterfaces: boolean = true): Promise<MsgStoreAndInstantiateContractResponse> {
    ...
    return promise.then(data => MsgStoreAndInstantiateContractResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  removeCodeUploadParamsAddresses(request: MsgRemoveCodeUploadParamsAddresses, useInterfaces: boolean = true): Promise<MsgRemoveCodeUploadParamsAddressesResponse> {
    ...
    return promise.then(data => MsgRemoveCodeUploadParamsAddressesResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  addCodeUploadParamsAddresses(request: MsgAddCodeUploadParamsAddresses, useInterfaces: boolean = true): Promise<MsgAddCodeUploadParamsAddressesResponse> {
    ...
    return promise.then(data => MsgAddCodeUploadParamsAddressesResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  storeAndMigrateContract(request: MsgStoreAndMigrateContract, useInterfaces: boolean = true): Promise<MsgStoreAndMigrateContractResponse> {
    ...
    return promise.then(data => MsgStoreAndMigrateContractResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
  updateContractLabel(request: MsgUpdateContractLabel, useInterfaces: boolean = true): Promise<MsgUpdateContractLabelResponse> {
    ...
    return promise.then(data => MsgUpdateContractLabelResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
}
  ...
  return mountedInBrowser
    ? createPortal(
        ...
        >
          <div
            className={clsx(
              'relative flex h-min max-h-[98vh] max-w-[98vw] cursor-auto flex-col overflow-x-hidden rounded-lg border border-border-secondary bg-background-base shadow-dp8 transition-transform duration-[120ms] sm:max-h-[82vh] sm:max-w-md',

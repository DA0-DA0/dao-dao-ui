  ...
  return (
    <div className="mx-2 flex max-w-[1044px] flex-col gap-6">
      <div className="flex flex-wrap justify-center gap-6">
        <div className="bg-background-secondary flex flex-col gap-8 rounded p-6 md:py-14 md:px-12">
          <div className="bg-background-primary flex h-fit w-fit items-center justify-center rounded p-2">
        ...
        <div
          className="bg-background-secondary relative grow rounded"
          style={{
            backgroundImage:
      ...
      <div
        className="bg-background-secondary relative rounded p-6 md:py-14 md:px-12"
        style={{
          backgroundImage:

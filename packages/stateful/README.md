...
| [`modules`](./modules)                                 | Adapter system that supports various modules that a DAO can add to its interface.                                                                                                               |
...
| [`queries`](./queries)                                 | [React Query](https://tanstack.com/query/latest/docs/framework/react/overview) queries.                                                                                                         |

...
export type CreateNftCollectionActionData = {
  chainId: string
  name: string
  symbol: string
}
...
export const CreateNftCollectionAction: ActionComponent = ({
  isCreating,
  fieldNamePrefix,
  errors,
}) => {
  const { t } = useTranslation()
  const { register, watch } = useFormContext<CreateNftCollectionActionData>()

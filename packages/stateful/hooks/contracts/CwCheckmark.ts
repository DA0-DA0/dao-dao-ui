...
import { CwCheckmarkClient as ExecuteClient } from '@dao-dao/state/contracts/CwCheckmark'
import {
  ExecuteClientParams,
  executeClient,
} from '@dao-dao/state/recoil/selectors/contracts/CwCheckmark'
...
export const useDelete = wrapExecuteHook('delete')

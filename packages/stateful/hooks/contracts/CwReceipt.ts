...
import { CwReceiptClient as ExecuteClient } from '@dao-dao/state/contracts/CwReceipt'
import {
  ExecuteClientParams,
  executeClient,
} from '@dao-dao/state/recoil/selectors/contracts/CwReceipt'
...
export const usePay = wrapExecuteHook('pay')

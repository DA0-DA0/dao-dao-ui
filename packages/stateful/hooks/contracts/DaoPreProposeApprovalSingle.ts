...
import { DaoPreProposeApprovalSingleClient as ExecuteClient } from '@dao-dao/state/contracts/DaoPreProposeApprovalSingle'
import {
  ExecuteClientParams,
  executeClient,
} from '@dao-dao/state/recoil/selectors/contracts/DaoPreProposeApprovalSingle'
...
export const useExtension = wrapExecuteHook('extension')

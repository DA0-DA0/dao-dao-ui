...
export class CwdProposalMultipleQueryClient
  implements CwdProposalMultipleReadOnlyInterface
{
...
export interface CwdProposalMultipleInterface
  extends CwdProposalMultipleReadOnlyInterface {
  contractAddress: string
  sender: string
  propose: (
    {
...
export class CwdProposalMultipleClient
  extends CwdProposalMultipleQueryClient
  implements CwdProposalMultipleInterface
{

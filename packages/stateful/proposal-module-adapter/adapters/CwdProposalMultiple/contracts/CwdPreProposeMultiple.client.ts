...
export class CwdPreProposeMultipleQueryClient
  implements CwdPreProposeMultipleReadOnlyInterface
{
...
export interface CwdPreProposeMultipleInterface
  extends CwdPreProposeMultipleReadOnlyInterface {
  contractAddress: string
  sender: string
  propose: (
    {
...
export class CwdPreProposeMultipleClient
  extends CwdPreProposeMultipleQueryClient
  implements CwdPreProposeMultipleInterface
{

...
export const CwdProposalMultipleAdapter: ProposalModuleAdapter<
  DaoCreationConfig,
  MultipleChoiceVote,
  NewProposalForm
> = {
  id: 'CwdProposalMultiple',
  contractNames: ['cwd-proposal-multiple'],
  ...
  queries: {
    proposalCount: {
      indexerFormula: 'cwdProposalMultiple/proposalCount',
      cosmWasmQuery: {
        proposal_count: {},
      },
    },

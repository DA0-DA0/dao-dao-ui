...
import { CwdProposalMultipleAdapter } from '../../index'
...
export default {
  title:
    'DAO DAO / packages / proposal-module-adapter / adapters / CwdProposalMultiple / common / ui / NewProposal',

...
export const CreateGroupsProposal = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): CreateGroupsProposal {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.createGroups.push(CreateGroup.decode(reader, reader.uint32(), useInterfaces));
          break;
        default:
  ...
  toAminoMsg(message: CreateGroupsProposal, useInterfaces: boolean = false): CreateGroupsProposalAminoMsg {
    return {
      type: "osmosis/incentives/create-groups-proposal",
      value: CreateGroupsProposal.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: CreateGroupsProposalProtoMsg, useInterfaces: boolean = false): CreateGroupsProposal {
    return CreateGroupsProposal.decode(message.value, undefined, useInterfaces);
  },

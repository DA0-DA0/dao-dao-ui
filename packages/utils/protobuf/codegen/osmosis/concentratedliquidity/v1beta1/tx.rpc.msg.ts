...
export class MsgClientImpl implements Msg {
  ...
  transferPositions(request: MsgTransferPositions, useInterfaces: boolean = true): Promise<MsgTransferPositionsResponse> {
    ...
    return promise.then(data => MsgTransferPositionsResponse.decode(new BinaryReader(data), undefined, useInterfaces));
  }
}
...
export const MsgSetSendEnabled = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgSetSendEnabled {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(message: MsgSetSendEnabled, useInterfaces: boolean = false): MsgSetSendEnabledAmino {
    const obj: any = {};
    obj.authority = message.authority;
  ...
  toAminoMsg(message: MsgSetSendEnabled, useInterfaces: boolean = false): MsgSetSendEnabledAminoMsg {
    return {
      type: "cosmos-sdk/MsgSetSendEnabled",
      value: MsgSetSendEnabled.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgSetSendEnabledProtoMsg, useInterfaces: boolean = false): MsgSetSendEnabled {
...
export const MsgSetSendEnabledResponse = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): MsgSetSendEnabledResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toAmino(_: MsgSetSendEnabledResponse, useInterfaces: boolean = false): MsgSetSendEnabledResponseAmino {
    const obj: any = {};
    return obj;
  },
  ...
  toAminoMsg(message: MsgSetSendEnabledResponse, useInterfaces: boolean = false): MsgSetSendEnabledResponseAminoMsg {
    return {
      type: "cosmos-sdk/MsgSetSendEnabledResponse",
      value: MsgSetSendEnabledResponse.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: MsgSetSendEnabledResponseProtoMsg, useInterfaces: boolean = false): MsgSetSendEnabledResponse {

...
export const QueryInterchainAccountRequest = {
  ...
  toAminoMsg(message: QueryInterchainAccountRequest, useInterfaces: boolean = false): QueryInterchainAccountRequestAminoMsg {
    return {
      type: "cosmos-sdk/QueryInterchainAccountRequest",
...
export const QueryInterchainAccountResponse = {
  ...
  toAminoMsg(message: QueryInterchainAccountResponse, useInterfaces: boolean = false): QueryInterchainAccountResponseAminoMsg {
    return {
      type: "cosmos-sdk/QueryInterchainAccountResponse",

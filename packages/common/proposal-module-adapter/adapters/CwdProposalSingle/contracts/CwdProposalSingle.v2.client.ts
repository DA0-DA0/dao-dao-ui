...
export class CwdProposalSingleV2QueryClient
  implements CwdProposalSingleV2ReadOnlyInterface
{
...
export interface CwdProposalSingleV2Interface
  extends CwdProposalSingleV2ReadOnlyInterface {
  contractAddress: string
  sender: string
  propose: (
    {
...
export class CwdProposalSingleV2Client
  extends CwdProposalSingleV2QueryClient
  implements CwdProposalSingleV2Interface
{
